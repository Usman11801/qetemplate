            ...
            <div className="flex flex-col gap-4">
              <div className="flex  gap-4">
                ...
                <label className="flex-1">
                  ...
                  <div className="flex justify-center items-center w-full h-10 overflow-hidden rounded-lg shadow">
                    <input
                      type="color"
                      value={selectedComponent?.optionBorderColor || "#3b82f6"}
                      onChange={(e) =>
                        onComponentUpdate(questionId, selectedComponent.id, {
                ...
                <label className="flex-1">
                  ...
                  <input
                    type="number"
                    value={selectedComponent?.optionBorderWidth || 0}
                    onChange={(e) =>
                      onComponentUpdate(questionId, selectedComponent.id, {
              ...
              <div className="flex gap-4">
                ...
                <label className="flex-1">
                  ...
                  <select
                    value={selectedComponent?.optionBorderStyle || "solid"}
                    onChange={(e) =>
                      onComponentUpdate(questionId, selectedComponent.id, {
                        optionBorderStyle: e.target.value,
                      })
                    }
                    className="block w-full rounded-md border border-gray-300 p-2 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  >
...
export default MatchingPairsToolbar;
