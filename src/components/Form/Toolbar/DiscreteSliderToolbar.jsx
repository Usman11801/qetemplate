              ...
              <div className="flex gap-4">
                ...
                <label>
                  ...
                  <div className="flex justify-center items-center w-full h-10 overflow-hidden rounded-lg shadow-lg">
                    <input
                      type="color"
                      value={selectedComponent?.optionSliderColor || "#f9fafb"}
                      onChange={(e) =>
                        onComponentUpdate(questionId, selectedComponent.id, {
                          optionSliderColor: e.target.value,
                        })
                      }
                      className="w-[calc(100%+8px)] h-14 -m-1 border-none p-0 focus:outline-none ring-0 outline-none"
                    />
                ...
                <label>
                  ...
                  <div className="flex justify-center items-center w-full h-10 overflow-hidden rounded-lg shadow-lg">
                    <input
                      type="color"
                      value={
                        selectedComponent?.optionSliderBackgroundColor ||
                        "#f9fafb"
                      }
                      onChange={(e) =>
                        onComponentUpdate(questionId, selectedComponent.id, {
                          optionSliderBackgroundColor: e.target.value,
                        })
                      }
                      className="w-[calc(100%+8px)] h-14 -m-1 border-none p-0 focus:outline-none ring-0 outline-none"
                    />
...
export default DiscreteSliderToolbar;
